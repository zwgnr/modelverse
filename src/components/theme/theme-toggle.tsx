...
export function ThemeToggle({ className }: ThemeToggleProps) {
	...
	return (
		<div
			className={cn(
				"relative flex items-center gap-1 overflow-hidden rounded-xl border border-black/10 bg-black/[0.01] p-1 backdrop-blur-md backdrop-saturate-150 before:absolute before:inset-0 before:rounded-xl before:bg-gradient-to-br before:from-black/2 before:via-transparent before:to-transparent dark:border-white/10 dark:bg-white/[0.01] dark:shadow-black/30 dark:before:from-white/2",
				className,
			)}
		>
			<Button
